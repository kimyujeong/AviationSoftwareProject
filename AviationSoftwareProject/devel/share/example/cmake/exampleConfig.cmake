...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /home/yujung/example/src/example)
  set(example_DEVEL_PREFIX /home/yujung/example/devel)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /home/yujung/example/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://www.modulabs.co.kr/DCUlab_main " STREQUAL " ")
    set(_report "Check the website 'http://www.modulabs.co.kr/DCUlab_main' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Mansoo <kmansoo@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yujung/example/src/example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yujung/example/devel/lib;/opt/ros/kinetic/lib)
